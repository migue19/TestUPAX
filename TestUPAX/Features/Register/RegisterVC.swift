...
class RegisterVC: BaseController {
    ...
    func setupView() {
        ...
        self.containerView.addSubviews(titleLabel, userTxt, lastNameTxt, lastName2Txt, segmentedControl, dateTxt, continueButton)
        ...
        self.continueButton.topAnchor.constraint(equalTo: self.dateTxt.bottomAnchor, constant: 80).isActive = true
        self.continueButton.leftAnchor.constraint(equalTo: self.containerView.leftAnchor, constant: margin).isActive = true
        self.continueButton.rightAnchor.constraint(equalTo: self.containerView.rightAnchor, constant: -margin).isActive = true
        self.continueButton.heightAnchor.constraint(equalToConstant: 46).isActive = true
